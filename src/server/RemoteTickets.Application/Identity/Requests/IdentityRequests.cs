namespace RemoteTickets.Application.Identity.Requests;
...
/// <param name="TenantId">The tenant route identifier used to validate token scope.</param>
public sealed record RefreshTokenCommand(string RefreshToken, string? TenantId = null) : IRequest;
